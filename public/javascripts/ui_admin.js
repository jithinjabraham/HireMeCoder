...
var appVue = new Vue({
  ...
  data: {
    ...
    allQuestions: {
      // data: [{
      //     id: 1,
      //     text: 'Q1:Trig Identity'
      //   },
      //   {
      //     id: 2,
      //     text: 'Q2:Even Numbers'
      //   },
      //   {
      //     id: 3,
      //     text: 'Q3:Sort Customers'
      //   },
      //   {
      //     id: 4,
      //     text: 'Q4:Code Analysis'
      //   },
      //   {
      //     id: 5,
      //     text: 'Q5:Fibonacci'
  ...
  methods: {
    ...
    getCandidates() {
      ...
      //     var res = JSON.parse(xhttp.response);
      //     ptrToData.savedCandidates = res;
      //   }
      // };

      // // Open connection
      // xhttp.open("GET", "/candidates.json", true);
    ...
    save_chosen_questions: function(event) {
      ...
      xhttp.onreadystatechange = function() {
        if (this.readyState == 4 && this.status == 200) {
          // do stuff if successful
          alert("Saved " + numQuestionsAdded + " questions to this test.");
          //empty the candidates array
    ...
    assignTestToCandidates: function(event) {
      ...
      candidateIDs = [];
      for (var i = 0; i < appVue.savedCandidates.length; i++) {
        candidateIDs.push(appVue.savedCandidates[i].id);
      }

      xhttp.send(JSON.stringify({
        candidate_ids: candidateIDs,
        question_ids: appVue.chosenQuestions,
        test_end_time: appVue.testEndDate
      }));
    }
